...
<div class="row main-content" style="font-size: 1.2rem;">
    <form role="form" class="form-horizontal" method="post" action="${contextPath }/userinfo/create" id="saveForm" onsubmit="return doSave(this);">
        <div class="form-group">
            <div class="col-sm-7">
                <span class="label" style="margin-left: 20px; font-size: 1.5rem; font-weight: 100; border-radius: 0; background-color: #4d9e4f;">新建用户</span>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-6">
                <select class="form-control" name="orgId">
                    ...
                    <c:forEach var="item" items="${resorgs}">
                        <c:choose>
                            <c:when test="${useraccount.orgId == item.orgId }">
            ...
            <div class="col-md-3 col-sm-6">
                <select class="form-control" name="userType" id="userType">
                    <option value="1" <c:if test="${useraccount.userType == 1}">selected</c:if>>SIP</option>
                    <option value="2" <c:if test="${useraccount.userType == 2}">selected</c:if>>DC</option>
                    <option value="3" <c:if test="${useraccount.userType == 3}">selected</c:if>>VoLTE</option>
                    <option value="4" <c:if test="${useraccount.userType == 4}">selected</c:if>>摄像头</option>
                    <option value="5" <c:if test="${useraccount.userType == 5}">selected</c:if>>PDT</option>
                    <option value="6" <c:if test="${useraccount.userType == 6}">selected</c:if>>POC</option>
                    <option value="7" <c:if test="${useraccount.userType == 7}">selected</c:if>>LTE数据终端</option>
                    <option value="8" <c:if test="${useraccount.userType == 8}">selected</c:if>>无线集群终端</option>
                </select>
            </div>
        </div>
            ...
            <div class="panel panel-primary" style="margin: 0 0 0 15px;">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <input type="text" class="form-control" name="subNo" id="subNo" value="" readonly>
                        </div>
                    </div>
            ...
            <div class="panel panel-primary" style="margin: 0 0 0 15px;">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <input type="text" class="form-control" name="imsi" id="imsi" value="" readonly>
                        </div>
                    </div>
            ...
            <div class="panel panel-primary" style="margin: 0 0 0 15px;">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <input type="text" class="form-control" name="subName" placeholder="请输入用户名">
                        </div>
                        <label for="subPassword" class="control-label col-md-1 col-sm-6">密码 *</label>
                        <div class="col-md-3 col-sm-6">
                            <input type="text" class="form-control" name="subPassword" placeholder="请输入密码" value="123456">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-6">
                            <input type="text" class="form-control" name="noCondFwdNo" placeholder="请输入无条件呼叫前转号码">
                        </div>
                        <label for="noReachFwdNo" class="control-label col-md-1 col-sm-6">不可达呼叫前转号码 </label>
                        <div class="col-md-2 col-sm-6">
                            <input type="text" class="form-control" name="noReachFwdNo" placeholder="请输入不可达呼叫前转号码">
                        </div>
                        <label for="noReplyFwdNo" class="control-label col-md-1 col-sm-6">无应答呼叫前转号码 </label>
                        <div class="col-md-2 col-sm-6">
                            <input type="text" class="form-control" name="noReplyFwdNo" placeholder="请输入无应答呼叫前转号码">
                        </div>
                        <label for="busyFwdNo" class="control-label col-md-1 col-sm-6">遇忙前转号码 </label>
                        <div class="col-md-2 col-sm-6">
                            <input type="text" class="form-control" name="busyFwdNo" placeholder="请输入遇忙前转号码">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-6 emgyNoClass" style="display: none;">
                            <input type="text" class="form-control" name="emgySingleNo" placeholder="请输入紧急单呼号码">
                        </div>
                        <label for="emgyGroupNo" class="control-label col-md-1 col-sm-6 emgyNoClass" style="display: none;">紧急组呼号码 </label>
                        <div class="col-md-2 col-sm-6 emgyNoClass" style="display: none;">
                            <input type="text" class="form-control" name="emgyGroupNo" placeholder="请输入紧急组呼号码">
                        </div>
                        <label for="pnasRegCircle" class="control-label col-md-1 col-sm-6">PNAS注册周期 (s)</label>
                        <div class="col-md-2 col-sm-6">
                            <input type="text" class="form-control" name="pnasRegCircle" placeholder="请输入PNAS注册周期 " value="7200">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 authGDCNoClass" style="display: none;">
                            <input type="text" class="form-control" name="authGDCNo" placeholder="请输入授权调度台号">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="subShortCode" class="control-label col-md-1 col-sm-6">短号 </label>
                        <div class="col-md-3 col-sm-6">
                            <input type="text" class="form-control" name="subShortCode" placeholder="请输入短号">
                        </div>
                    </div>
                </div>
            </div>
