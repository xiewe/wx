...
<div class="row main-content">
    <form id="saveForm" class="form-horizontal" role="form" method="post" action="${contextPath }/op/update" onsubmit="return doSave(this, '${contextPath }/op/list');">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="password" value="${organization.password }" placeholder="请输入管理员密码">
            </div>
        </div>
        <div class="form-group">
            <label for="confirmPassword" class="col-sm-2 control-label">确认密码 *</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="confirmPassword" value="${organization.password }" placeholder="请输入确认密码">
            </div>
        </div>
        <div class="form-group">
