...
function assignPermissionDataControl() {
	var data = "id=${role.id }&";
	var rpIndex = 0;	
	$(".rpdcs").each(function(){
	...
	$.post(
		"${contextPath }/security/role/assign", 
		data, 
...
<form>
	...
	<div class="divider"></div>
		<table class="treeTable list" width="100%">
			...
			<tr id="tr_${item.key.id}" pid="${item.key.id }">
				...
				<td><a iconClass="database_add"  href="${contextPath }/security/role/lookup?rp.id=${rp.id }&prefix=rolePermissions[${index }]." 
	...
	<div class="formBar">
		<ul>
			<li><div class="button"><div class="buttonContent"><button type="button" onclick="assignPermissionDataControl()">确定</button></div></div></li>
