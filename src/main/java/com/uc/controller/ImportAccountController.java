...
public class ImportAccountController extends BaseController {
    ...
    private static final String CREATE = "biz/mgruser/importaccount/create";
    private static final String UPDATE = "biz/mgruser/importaccount/update";
    private static final String LIST = "biz/mgruser/importaccount/list";
    private static final String VIEW = "biz/mgruser/importaccount/view";
