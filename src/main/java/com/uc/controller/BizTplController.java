...
public class BizTplController extends BaseController {
    ...
    @Log(message = "添加了业务模板:{0}", level = LogLevel.INFO, catrgory = "uc")
    @RequiresPermissions("BizTpl:create")
    ...
    @Log(message = "删除了业务模板:{0}", level = LogLevel.INFO, catrgory = "uc")
    ...
    @Log(message = "修改了业务模板:{0}的信息", level = LogLevel.INFO, catrgory = "uc")
    @RequiresPermissions("BizTpl:update")
