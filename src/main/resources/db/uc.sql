...
(2,'系统管理','组织管理','/org',1,NULL,NULL,NULL),
(3,'系统管理','角色管理','/role',1,NULL,NULL,NULL),
(4,'系统管理','用户管理','/user',1,NULL,NULL,NULL),
(5,'系统管理','系统日志','/log',1,NULL,NULL,NULL),
(11,'模板管理','模板管理','',NULL,NULL,NULL,NULL),
(12,'模板管理','OP模板','/op',11,NULL,NULL,NULL),
(13,'模板管理','APN模板','/apn',11,NULL,NULL,NULL),
(14,'模板管理','APN组模板','/apngroup',11,NULL,NULL,NULL),
(15,'模板管理','业务模板','/biz',11,NULL,NULL,NULL),
(21,'资源管理','资源管理',NULL,NULL,NULL,NULL,NULL),
(22,'资源管理','IMSI管理','/imsi',21,NULL,NULL,NULL),
(23,'资源管理','静态IP管理','/ip',21,NULL,NULL,NULL),
(24,'资源管理','组织管理','/resorg',21,NULL,NULL,NULL),
(25,'资源管理','号段管理','/no',21,NULL,NULL,NULL),
(26,'资源管理','白名单管理','/whitelist',21,NULL,NULL,NULL),
(27,'资源管理','黑名单管理','/blacklist',21,NULL,NULL,NULL),
(31,'用户管理','用户管理',NULL,NULL,NULL,NULL,NULL),
(32,'用户管理','用户信息','/userinfo',31,NULL,NULL,NULL),
(33,'用户管理','用户开户','/openaccount',31,NULL,NULL,NULL),
(34,'用户管理','批量开户','/importaccout',31,NULL,NULL,NULL),
